...
public class ProductPageFragment extends Fragment {
     ...
     *
     * @param productImage product image as an int .
     * @param productName Parameter 2.
     * @return A new instance of fragment ProductPageFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ProductPageFragment newInstance(String productImage, String productName) {
        ProductPageFragment fragment = new ProductPageFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, productImage);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            productImage = getArguments().getString(ARG_PARAM1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView productImageView = getView().findViewById(R.id.product_imageCard_image);
        Glide.with(getActivity()).load(productImage).into(productImageView);
